	...
	[
...

		{
			...
			[
				...
				'src/effects/shadows/SkAmbientShadowMaskFilter.h',
				'src/effects/shadows/SkSpotShadowMaskFilter.h',
			...
			[
				...
				['exclude', '^src/codec/.*Webp.*'],
				['exclude', '^src/codec/.*Jpeg.*'],
				['exclude', '^src/codec/.*Png.*'],
				['exclude', '^src/codec/.*Ico.*'],
				['exclude', '^src/codec/.*Raw.*'],
